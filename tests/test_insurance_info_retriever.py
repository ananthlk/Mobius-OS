#!/usr/bin/env python3
"""
Test Insurance Info Retriever Tool
...
from nexus.tools.eligibility.gate1_data_retrieval import InsuranceInfoRetriever

def test_tool():
    """Test the InsuranceInfoRetriever tool"""
    print("\n" + "=" * 90)
    print("🧪 TESTING: insurance_info_retriever")
    print("=" * 90)
    print()
    ...
    try:
        ...
        print(f"   API endpoint: /api/user-profiles/{{patient_id}}/health-plan")
